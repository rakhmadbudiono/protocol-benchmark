...
type HelloWorldClient interface {
	GetPackage(ctx context.Context, in *Void, opts ...grpc.CallOption) (*Package, error)
}
...
func (c *helloWorldClient) GetPackage(ctx context.Context, in *Void, opts ...grpc.CallOption) (*Package, error) {
	out := new(Package)
	err := c.cc.Invoke(ctx, "/HelloWorld/GetPackage", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type HelloWorldServer interface {
	GetPackage(context.Context, *Void) (*Package, error)
...
func (UnimplementedHelloWorldServer) GetPackage(context.Context, *Void) (*Package, error) {
...
func _HelloWorld_GetPackage_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(Void)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(HelloWorldServer).GetPackage(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/HelloWorld/GetPackage",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(HelloWorldServer).GetPackage(ctx, req.(*Void))
	}
	...
	Methods: []grpc.MethodDesc{
		{
			...
			Handler:    _HelloWorld_GetPackage_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "servers/model/hello-world.proto",
}
